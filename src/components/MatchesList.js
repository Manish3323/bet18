...
class MatchesList extends Component {
  ...
  renderList () {
    ...
    if (this.props.matches.length > 0) {
      return (<ListView style={ListViewStyle} contentContainerStyle={{flex: 1}} enableEmptySections dataSource={this.dataSource} renderRow={(rowData) => this.renderGamebind(rowData)} />)
    } else {
